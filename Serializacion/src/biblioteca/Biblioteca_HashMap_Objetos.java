package biblioteca;
/**
 * Write a description of class Bibloteca_HashMap_Objetos here.
...
public class Biblioteca_HashMap_Objetos
{
   ...
   public static void main ( String argv[]){
    ...
    private static void salvarCatalogo ( HashMap <String,Libro> mlibros , String fichero)
    {
    try{
        ...
        // Recorro el HastMap y grabo libro a libro 
        for (Map.Entry claveLibro: mlibros.entrySet()){
            oos.writeObject(claveLibro.getValue());
    ...
    private static  HashMap <String,Libro> cargarCatalogo (String fichero){
        ...
        try{
         ...
         try {
                ...
                while ( true ){
                    resu.put(unlibro.titulo,unlibro);
