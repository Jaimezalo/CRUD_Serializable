 ...
 *  UTILIZA LA SERIALIZACIÓN GRABANDO EL ARRAYLIST COMPLETO
...
public class Biblioteca_ArrayList
{
    
    
    static final String LIBROS_DISPONIBLES = "disponiblesAL.objetos";
    static final String LIBROS_PRESTADOS   = "prestadosAL.objetos";
   ...
   public static void main ( String argv[]){
    ...
    private static   ArrayList <Libro> cargarCatalogo (String fichero){
        ...
        try{
         ...
         resu = ( ArrayList <Libro> ) oinput.readObject(); 
